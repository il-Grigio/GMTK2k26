Shader "Custom/ToonShader4Level_Wall"
{
    Properties
    {
        [Header(Base)]
        ...
        [Header(Wall Hole Stencil)]
        [IntRange] _StencilRef ("Stencil Ref (deve combaciare con la sfera)", Range(0,255)) = 1
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // --- WALL HOLE: scarta il pixel se e' dentro l'area marcata
            // dalla sfera attorno al player (stesso Ref della sfera).
            // Va messo anche qui, non solo su ForwardLit, altrimenti
            // l'outline (ZWrite On) lascerebbe comunque un guscio di
            // depth invisibile dentro al buco.
            Stencil
            {
                Ref [_StencilRef]
                Comp NotEqual
            ...
            struct Attributes
            {
                ...
                float3 smoothedNormalOS : TEXCOORD2;
            };
        ...
        Pass
        {
            ...
            // --- WALL HOLE: stesso test stencil dell'Outline. Qui e'
            // il pass che effettivamente "buca" visivamente il muro.
            Stencil
            {
                Ref [_StencilRef]
                Comp NotEqual
        ...
        // Pass per proiettare/ricevere ombre correttamente (NON toccato:
        // usa un render target separato, lo stencil della camera non
        // gli si applica).
        Pass
        {
            Name "ShadowCaster"
